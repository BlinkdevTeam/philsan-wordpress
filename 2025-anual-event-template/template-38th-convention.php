                ...
                <div class="flex flex-col items-center gap-[10px]">
                    ...
                    <div id="countdown" class="flex gap-4 text-[#1F773A]">
                        <div class="flex flex-col items-center justify-center">
                            <span class="font-bold font-[28px]" id="days">00</span>
                            <div class="text-sm">Days</div>
                        </div>
                        <div>:</div>
                        <div class="flex flex-col items-center justify-center">
                            <span class="font-bold font-[28px]" id="hours">00</span>
                            <div class="text-sm">Hours</div>
                        </div>
                        <div>:</div>
                        <div class="flex flex-col items-center justify-center">
                            <span class="font-bold font-[28px]" id="minutes">00</span>
                            <div class="text-sm">Minutes</div>
                        </div>
                        <div>:</div>
                        <div class="flex flex-col items-center justify-center">
                            <span class="font-bold font-[28px]" id="seconds">00</span>
