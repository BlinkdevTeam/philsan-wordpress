                            ...
                            <div class="flex justify-center gap-[40px] flex-wrap pt-[50px]">
                                <?php if (have_rows('speaker')) : ?>
                                    <?php while (have_rows('speaker')) : the_row(); ?>
                                        <div class="speaker-item relative flex flex-row md:flex-col h-[150px] md:h-[auto] items-end md:items-center justify-center w-full sm:w-[280px] lg:w-[350px] group-hover">
                                            ...
                                            <div class="flex-1 w-full flex flex-col items-center rounded-br-[50px] h-[100%] md:h-auto justify-center gap-2.5 py-5 px-5 bg-[#1F773A] hover:bg-[#EDB221] text-white">
