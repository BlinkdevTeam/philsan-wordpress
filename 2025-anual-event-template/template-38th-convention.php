...
<div class="hero-section bg-[linear-gradient(to_bottom,#ffffff_0%,#ffffff_60%,#CBF9B6_100%)] overflow-hidden">
    <div class="flex gap-[50px] w-[1280px] mx-auto">
        <div class="flex flex-col w-[50%] gap-[20px]">
            ...
            <a class="w-max bg-gradient-to-r from-[#1F773A] to-[#EDB221] text-[#ffffff] text-[28px] py-[20px] px-[50px] rounded-tl-[80px] rounded-br-[80px]" href="">Register</a>
        </div>
        <div class="relative w-[50%]">
            <img class="z-[2]" src="https://philsan.org/wp-content/uploads/2025/06/Philsan-Ticket-BG@3x-8-2.png" alt="">
            <img class="absolute z-[1] bottom-[-30px] transform scale-110 opacity-[0.2]" src="https://philsan.org/wp-content/uploads/2025/06/Philsan-Ticket-BG@3x-8-2.png" alt="">
        </div>
    </div>
</div>
