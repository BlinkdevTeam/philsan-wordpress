...
<div class="footer-temporary relative overflow-hidden">
    <div class="w-[90%] max-w-[1280px] mx-auto pt-[80px] pt-[110px] py-[100px]">
        <div class="flex gap-[50px] justify-between">
            ...
            <div class="bg-[#1F773A] p-[20px] border-bl-[80px]">
                <h6>Contact Us</h6>
                <div>
