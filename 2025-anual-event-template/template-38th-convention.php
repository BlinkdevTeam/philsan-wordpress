                ...
                <div class="swiper-wrapper">
                    <?php if (have_rows('sponsor_group', $page->ID)) : ?>
                        <?php while (have_rows('sponsor_group', $page->ID)) : the_row(); ?>
                            <div class="swiper-slide md:pt-[70px] justify-center">
                    ...
                    <div>
                        ...
                        <ul class="flex flex-col pt-[10px] pl-[10px] gap-[5px]">
                            <li class="flex gap-[8px] items-center">
                                ...
                                <p class="text-[14px] md:text-[16px] w-max">09171169043</p></li>
                            <li class="flex gap-[8px] items-center">
                                <div class="flex justify-center items-center p-[5px] w-[30px] h-[30px] rounded-full bg-[#ffffff]">
                                ...
                                <p class="text-[14px] md:text-[16px] w-max">admin@philsan.org</p>
                            </li>
                            <li class="flex gap-[8px] items-center">
                                <div class="flex justify-center items-center p-[5px] w-[30px] h-[30px] rounded-full bg-[#ffffff]">
                                ...
                                <p class="text-[14px] md:text-[16px] w-max">Official PHILSAN Facebook Page</p>
                            </li>
                        </ul>
                    </div>
                </div>
