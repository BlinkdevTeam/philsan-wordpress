                        ...
                        <div class="w-max">
                            <div>
                                <svg class="w-[33px] h-[58px]"viewBox="0 0 63 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path class="animate-flipY2 transition-transform" d="M63 30C63 13.4315 49.5685 0 33 0V35C33 46.0457 41.9543 55 53 55H63V30Z" fill="#EDB221"/>
                                    <path class="animate-flipY1 transition-transform" d="M0 58C0 74.5685 13.4315 88 30 88V78C30 66.9543 21.0457 58 10 58H0Z" fill="#1F773A"/>
