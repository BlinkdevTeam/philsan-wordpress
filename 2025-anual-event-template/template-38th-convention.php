...
<div class="program relative overflow-hidden">
    <div class="w-[90%] max-w-[1280px] mx-auto pt-[80px] pt-[110px] py-[100px]">
       <?php if ($page) : ?>
            <div class="flex flex-col gap-[20px] pb-[40px]">
...
<div class="footer-temporary relative overflow-hidden">
    <div class="w-[100%] mx-auto pt-[80px] pt-[110px] py-[100px]">
        <div class="flex gap-[50px] justify-between">
            ...
            <div class="w-[50%] bg-[#1F773A] p-[20px] rounded-bl-[80px] text-[#ffffff]">
                <h6>Contact Us</h6>
                <div>
