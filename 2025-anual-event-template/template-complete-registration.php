                        ...
                        <div class="flex flex-col lg:flex-row justify-between gap-[40px] pt-[20px]">
                            ...
                            <div class="w-[100%] flex flex-col gap-[15px]">
                                ...
                                <div class="flex pt-[20px] items-start gap-[10px] z-[1]">
                                    ...
                                    />
                                    <p class="sub-bi-heading text-[#344054] font-[200]">* I understand that my participation in the 38th PHILSAN Annual Convention is voluntary, and I may choose not to proceed.</br> I confirm that the personal information I provide is true and correct. This information will be kept confidential and used only for the PHILSAN Convention and PRC CPD unit application.</br> I agree to the processing of my personal data based on the PHILSAN Data Privacy Statement and the Data Privacy Act of 2012.</br> I also allow PHILSAN to take and use photos and videos of me during the event and use for purposes related to the convention only.</p>
                                </div>
