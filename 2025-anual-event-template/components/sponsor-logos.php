<div class="swiper mySwiper">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide p-[20px] shadow-lg">
            <div class="bg-[#1F773A] p-[10px]">
                <p class="font-fraunces font-bold text-[#ffffff]">3rd Level</p>
            </div>
            <img class="w-[80%]" src="https://philsan.org/wp-content/uploads/2025/06/Frame-2147226341-scaled.png" alt="">
        </div>
        <div class="swiper-slide p-[20px] shadow-lg">
            <div class="bg-[#1F773A] p-[10px]">
                <p class="font-fraunces font-bold text-[#ffffff]">2nd Level</p>
            </div>
            <img class="w-[80%]" src="https://philsan.org/wp-content/uploads/2025/06/Frame-2147226340-1-scaled.png" alt="">
        </div>
