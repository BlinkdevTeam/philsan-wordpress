        ...
        <div class="flex w-[100%] h-max">
            ...
            <div class="flex flex w-[80%] lg:w-[50%]">
                <div id="email-verification" class="w-[100%] text-black flex flex-col justify-center px-[50px]">
                    <div class="relative overflow-hidden pb-[125px] lg:pb-[160px] pt-[50px] w-auto h-auto flex flex-col justify-center px-[50px] py-[50px] rounded text-start bg-[linear-gradient(to_bottom,#ffffff_0%,#ffffff_60%,#CBF9B6_100%)] shadow-lg rounded-lg">
