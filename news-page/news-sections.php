...
<div class="with-filters pt-[50px]">
    <div class="custom-container">
        <div class="">
            ...
            <div class="flex justify-center gap-[50px] w-[90%] lg:w-[80%] xl:w-[800px] mx-auto pt-[20px]">
                ...
                <div id="openFilter" class="cursor-pointer flex items-center gap-[10px] px-[15px] py-[5px] border-[1px] border-[#1F773A] rounded-full w-fit">
