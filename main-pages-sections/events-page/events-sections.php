<?php
    ...
    $today = date('Ymd'); // format must match how you store event dates (e.g., YYYY-MM-DD)
    ...
    <div class="custom-container">
        <div class="">
            <div class="w-[100%] flex flex-col justify-center items-center h-[100%]">
                ...
                <p class="text-[24px] md:text-[42px] font-[700] text-[#1F773A]">Lorem ipsum dolor sit amet consectetur.</p>
            </div>
