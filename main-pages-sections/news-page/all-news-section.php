                ...
                <?php while ($all_news->have_posts()) : $all_news->the_post(); ?>
                    ...
                    <div class="">
                        ...
                        <div class="pt-[20px]">
                            ...
                            <h2 class="text-left text-[18px] font-[600] text-[#1f773a]"><?php echo esc_html($title_trimmed); ?></h2>
                            <p class="text-left text-[14px] font-[400]"><?php echo esc_html($desc_trimmed); ?></p>
                        </div>
