<div id="faq-section" class="w-[90%] md:w-[720px] mx-auto">
    <div class="pb-[100px]">
        <div class="pb-[30px]">
            <h2 class="text-[24px] md:text-[32px] font-[800] text-[#1F773A] text-center">Frequently Asked Questions</h2>
        </div>
            ...
            <?php while ( have_rows('faqs') ): the_row(); ?>
                ...
                <div id="faq-group-<?php echo $faq_index; ?>" class="flex flex-col py-[20px] md:gap-[20px] border-b-[1px] border-b-[#CCCCCC]">
                    ...
                    <div 
                        ...
                        class="flex justify-between items-start cursor-pointer transition-all duration-300 ease group gap-[20px]"
                    >
                        <h6 class="text-[18px] md:text-[24px] text-[#000000] font-[600] group-hover:text-[#1F773A] transition-all duration-300 ease">
                    ...
                    >
                        <div id="answer-<?php echo $faq_index; ?>" class="answer text-[14px] md:text-[18px] text-[#2f2f2f]">
